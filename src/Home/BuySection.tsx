...
export default function BuySection() {
  return (
    <section className="py-24 px-14 bg-linear-to-br from-blue-50/50 via-white to-blue-50/30 relative overflow-hidden">
      {/* Decorative Elements */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="text-center mt-12">
          <button className="group/btn px-10 py-4 bg-linear-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-bold rounded-2xl shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300 relative overflow-hidden">
