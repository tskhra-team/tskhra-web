import { MagicSwap, SwapCards } from "@/Swapping/SwapCards";
...
export default function HeroSwipe() {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center pt-20 md:pt-0 relative pb-20 px-6">
              ...
              {tabs.map((tab) => (
                <motion.button
                  ...
                  style={{
                    ...
                    color:
                      activeTab === tab.id ? "white" : "var(--swap-text2)",
                    boxShadow:
                      activeTab === tab.id
