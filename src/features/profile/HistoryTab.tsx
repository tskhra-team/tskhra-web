      ...
      <TabsContent value="buying">
        <div className="space-y-4 mb-6">
          {getCurrentItems(buyingHistory).map((order) => (
            <div
              key={order.id}
              className="p-5 bg-white/80 backdrop-blur-sm border border-gray-200/50 rounded-2xl hover:shadow-md transition-shadow duration-200"
            >
            ...
            <PaginationContent>
              ...
              <PaginationItem>
                <PaginationNext
                  onClick={() =>
                    handlePageChange(
                      Math.min(getTotalPages(bookingHistory), currentPage + 1),
                    )
                  }
                  className={
            ...
            <PaginationContent>
              ...
              <PaginationItem>
                <PaginationNext
                  onClick={() =>
                    handlePageChange(
                      Math.min(getTotalPages(swappingHistory), currentPage + 1),
                    )
                  }
                  className={
